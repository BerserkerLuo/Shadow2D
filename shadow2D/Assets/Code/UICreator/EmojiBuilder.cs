...
public class EmojiBuilder  {
	...
	private const string OutputPath = "Assets/Res_AssetBundle/UI/Common/Icon/emoji/";
    private const string OutputConfigPath = "Assets/StreamingAssets/data/config/";

    private const string InputPath = "Assets/Res/UI/Common/Emoji/Input/";
	...
	public static void BuildEmoji()
	{
		...
		using (StreamWriter sw = new StreamWriter (OutputConfigPath + "emoji.txt",false)) {
