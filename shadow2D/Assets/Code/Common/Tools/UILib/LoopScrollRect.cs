...
namespace UnityEngine.UI
{
    ...
    public abstract class LoopScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        protected XUIAdaptList prefabSource;
        ...
        //[HideInInspector]
        //[NonSerialized]
        public UIEvent OnUpdateItem;
        public UIEvent OnDragEnd;
        ...
        {
            base.Awake();
            prefabSource = content.GetComponent<XUIAdaptList>();
        }
        ...
        public void ClearCells()
        {
            if (Application.isPlaying)
            {
                ...
                {
                    Transform childTrans = content.GetChild(i);
                    XUIListItem uiListItem = childTrans.GetComponent<XUIListItem>();
                    prefabSource.ReturnObject(uiListItem);
                }
            }
        }
        ...
        public void RefreshCells()
        {
            if (Application.isPlaying && this.isActiveAndEnabled)
            {
                ...
                for (int i = 0; i < content.childCount; i++)
                {
                    ...
                    {
                        Transform transChild = content.GetChild(i);
                        XUIListItem uiListItem = transChild.GetComponent<XUIListItem>();
                        uiListItem.Index = itemTypeEnd;
                        if (null != OnUpdateItem)
                        {
                            OnUpdateItem(uiListItem);
                        }
                    ...
                    {
                        XUIListItem uiListItem = content.GetChild(i).GetComponent<XUIListItem>();
                        prefabSource.ReturnObject(uiListItem);
                        i--;
                    }
                }
        ...
        public void RefillCellsFromEnd(int offset = 0)
        {
            ...
            {
                XUIListItem uiListItem = m_Content.GetChild(i).GetComponent<XUIListItem>();
                prefabSource.ReturnObject(uiListItem);
            }
        ...
        public void RefillCells(int offset = 0)
        {
            ...
            for (int i = m_Content.childCount - 1; i >= 0; i--)
            {
                Transform childTrans = m_Content.GetChild(i);
                XUIListItem uiListItem = childTrans.GetComponent<XUIListItem>();
                prefabSource.ReturnObject(uiListItem);
            }
        ...
        protected float DeleteItemAtStart()
        {
            ...
            for (int i = 0; i < contentConstraintCount; i++)
            {
                ...
                XUIListItem uiListItem = oldItem.GetComponent<XUIListItem>();
                prefabSource.ReturnObject(uiListItem);
        ...
        {
            XUIListItem uiListItem = prefabSource.GetObject();
            RectTransform nextItem = uiListItem.CachedRectTransform;
            nextItem.transform.SetParent(content, false);
            nextItem.gameObject.SetActive(true);
            uiListItem.Index = itemIdx;
            if (null != OnUpdateItem)
            {
                OnUpdateItem(uiListItem);
            }
